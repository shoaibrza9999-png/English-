...
<body class="bg-background text-on-background min-h-screen font-body-reading pb-24">
    ...
    <!-- HOME VIEW -->
    <main id="view-home" class="p-6 md:p-12 max-w-5xl mx-auto space-y-8">
        <div class="text-center space-y-4 mb-12">
            <h2 class="font-display-lg text-4xl text-primary">Library of Tales</h2>
            <p class="text-on-surface-variant text-lg">Unlock ancient wisdom through your voice.</p>
        </div>
    ...
    <main id="view-read" class="hidden p-6 md:p-12 max-w-3xl mx-auto flex flex-col items-center">
        <article class="w-full space-y-8">
            <div class="relative group aspect-[16/9] w-full overflow-hidden rounded-lg border border-outline-variant/20 shadow-lg">
                <img id="story-image" class="w-full h-full object-cover grayscale-[0.3] brightness-75 transition-transform duration-1000" src=""/>
            </div>

            <header class="text-center space-y-4">
                <h2 id="story-title" class="font-headline-lg text-3xl text-on-surface">Title</h2>
                <div class="flex items-center justify-center gap-2 text-outline">
                    <div class="h-px w-8 bg-outline/30"></div>
                    <span class="font-label-md uppercase tracking-widest">Reading Mode</span>
                    <div class="h-px w-8 bg-outline/30"></div>
                </div>
            </header>
            ...
            <section class="paper-grain relative bg-surface-container p-6 md:p-12 rounded-xl border border-outline-variant/10 shadow-sm text-xl md:text-2xl leading-relaxed text-on-surface-variant">
                <div id="story-text" class="space-y-4"></div>
                <div id="story-moral" class="mt-8 pt-4 border-t border-outline/20 text-primary italic hidden"></div>
            </section>

            <div class="bg-surface-container-high p-4 rounded-lg border border-outline-variant/20 text-center">
                <p class="text-sm text-outline mb-1 font-label-md uppercase tracking-widest">Listening Transcript</p>
                <p id="transcript-display" class="text-lg text-on-surface min-h-[1.5rem] italic">...</p>
            </div>
        </article>
        ...
        <nav class="fixed bottom-0 left-0 w-full z-50 flex justify-around items-center px-4 pb-6 pt-4 bg-surface-container border-t border-outline-variant/50 rounded-t-3xl shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
            ...
            <button class="flex flex-col items-center gap-1 group" onclick="startTranslationMode()">
                <div class="p-3 rounded-full bg-surface-container-high border border-outline-variant group-hover:bg-primary-container transition-colors">
                    <span class="material-symbols-outlined text-primary group-hover:text-on-primary-container">g_translate</span>
                </div>
                <span class="font-label-md text-outline">Translate</span>
            </button>
        </nav>
    </main>
        ...
        <div class="w-full space-y-12">
            <header class="text-center space-y-4">
                <div class="flex items-center justify-center gap-2 text-outline mb-8">
                    <div class="h-px w-8 bg-outline/30"></div>
                    <span class="font-label-md uppercase tracking-widest">Translation Challenge</span>
                    <div class="h-px w-8 bg-outline/30"></div>
                </div>
                <h2 id="trans-eng-text" class="font-headline-lg text-2xl md:text-4xl text-on-surface leading-normal text-center p-6 bg-surface-container rounded-xl border border-outline-variant/20"></h2>
            </header>

            <div class="space-y-6">
                <p class="font-label-lg text-outline text-center">Arrange the words in Hindi:</p>
    ...
    <script>
        ...
        // Reading State
        let storyWords = [];
        let rawWords = []; // with punctuation intact
        ...
        function startTranslationMode() {{
            ...
            document.getElementById('trans-eng-text').innerText = story.translation_sentence;

            sourceTransWords = [...story.jumbled_hindi]; // Clone
            selectedTransWords = [];
